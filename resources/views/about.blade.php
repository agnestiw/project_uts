    ...
    <main class="main" id="top">
      ...
      <section class="pb-0">
        ...
        <div class="container">
          <div class="gallery-wraper">
            <div class="img-wraper"><img class="img-fluid" src="assets_h/img/gallery/1.png" alt="" /></div>
            <div class="img-wraper"><img class="img-fluid" src="assets_h/img/gallery/2.png" alt="" /></div>
            <div class="img-wraper"><img class="img-fluid" src="assets_h/img/gallery/3.png" alt="" /></div>
            <div class="img-wraper"><img class="img-fluid" src="assets_h/img/gallery/4.png" alt="" /></div>
            <div class="img-wraper"><img class="img-fluid" src="assets_h/img/gallery/5.png" alt="" /></div>
          </div>
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row mt-7">
            <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets_h/img/team/1.png" alt="" /></a>
              <h1 class="fs-3 mt-3">Michael Scott</h1>
              <p class="fs-1">General Manager</p>
            </div>
            <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets_h/img/team/2.png" alt="" /></a>
              <h1 class="fs-3 mt-3">Dwight Schrute</h1>
              <p class="fs-1">General Manager</p>
            </div>
            <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets_h/img/team/3.png" alt="" /></a>
      ...
      <section class="bg-dark">
        ...
        <div class="container">
          <div class="px-xl-8 px-md-5 px-3">
            ...
            <div class="row mt-5">
              <div class="col-md-3"><img class="img-fluid" src="assets_h/img/values/1.png" alt="" /></div>
            ...
            <div class="row mt-5">
              <div class="col-md-3"><img class="img-fluid" src="assets_h/img/values/2.png" alt="" /></div>
              <div class="col-md-9 mt-2 mb-md-0">
            ...
            <div class="row mt-5">
              <div class="col-md-3"><img class="img-fluid" src="assets_h/img/values/3.png" alt="" /></div>
              <div class="col-md-9 mt-2 mb-md-0">
